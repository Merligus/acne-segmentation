...
python train_script.py --architecture SegFormer --segformer_model nvidia/segformer-b0-finetuned-ade-512-512 --epochs 50 --lr 6e-5 --batch_size 8 --img_size 512 512
```
